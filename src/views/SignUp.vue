        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
            ...
            <div class="card z-index-0">
                ...
                <div class="col-3 ms-auto px-1 ">
                    <a class="btn btn-outline-light border-0 rounded-circle" href="javascript:;">
                ...
                <div class="col-3 px-1">
                    <a class="btn btn-outline-light w-100 border-0" href="javascript:;">
                    <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g
                ...
                <div class="card-body">
                <form role="form">
                    <argon-input type="text" placeholder="NIK" aria-label="NIK" />
...
<script>
// import NavbarMain from "../examples/PageLayout/NavbarMain.vue";
import ArgonInput from "@/components/argon-components/ArgonInput.vue";
import ArgonCheckbox from "@/components/argon-components/ArgonCheckbox.vue";
import ArgonButton from "@/components/argon-components/ArgonButton.vue";
